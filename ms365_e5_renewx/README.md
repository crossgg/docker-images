...
[Docker Hub](https://hub.docker.com/r/crosscc/ms365-e5-renew-x)
...
拉取镜像  
`docker pull crosscc/ms365-e5-renew-x:latest`  
...
docker run -d \
    -p 1066:1066 \
    --name RnewX \
crosscc/ms365-e5-renew-x:latest
```
...
[Github下载Dockerfile](https://github.com/crosscc/ms365-e5-renew-x_docker)文件  
