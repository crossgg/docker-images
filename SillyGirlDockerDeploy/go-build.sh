...
git clone ${GITHUBPROXY}https://github.com/cdle/jd_price.git $CODE_DIR/develop/jd_price

# 短网址扩展库
git clone ${GITHUBPROXY}https://github.com/cdle/dwz.git $CODE_DIR/develop/dwz
...
import (
	...
	//短网址
	_ "github.com/cdle/sillyGirl/develop/dwz"
